...
buat agar ketika salah satu kanker dipilih, semua kanker ditampilkan di bawahnya, dan tombol check sekarang berada di paling bawah setelah semua kanker ditampilkan

Saya paham Anda ingin mengubah perilaku aplikasi sehingga ketika salah satu jenis kanker dipilih dari dropdown, semua jenis kanker (beserta gambar dan deskripsinya) ditampilkan di bawah dropdown, dan tombol "CHECK SEKARANG" ditempatkan di paling bawah setelah semua kanker ditampilkan. Berikut adalah kode yang telah dimodifikasi untuk mencapai tujuan tersebut:
